...
return [
    ...
    'backup' => [
         ...
         * the backups.
         */
        'name' => env('APP_NAME', 'SPO-Dashboard'),
        ...
        'destination' => [
             ...
             */
            'filename_prefix' => 'spodash_admin_',
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => 'ntikku@ptc.com',
            'from' => [
                'address' => env('MAIL_FROM_ADDRESS', 'spodash@ptc.com'),
                'name' => env('MAIL_FROM_NAME', 'SPO-Dashboard'),
            ],
        ],

        'slack' => [
            'webhook_url' => '',
            // 'webhook_url' => 'https://hooks.slack.com/services/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',
